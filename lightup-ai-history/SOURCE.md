...
- 生成元: `/Users/taka/Documents/Codex/2026-08-28/new-chat-3/work/lightup-ai-history-site`
- 公開URL: `https://writeup-inc.github.io/saas/lightup-ai-history/`
- 静的書き出し: Next.js `output: 'export'`

GitHub Pages向けに書き出す際は、生成元の作業コピーで次を設定してからビルドする。

1. `next.config.ts` に `output: 'export'`、`basePath` と `assetPrefix` に `/saas/lightup-ai-history`、`trailingSlash: true` を設定する。
